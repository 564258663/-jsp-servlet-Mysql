...
<%
    ...
    Connection conn=DriverManager.getConnection("jdbc:mysql://hanyy1022.mysql.rds.aliyuncs.com:3306/hanyy_zy?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=UTC", "hanyy_zy", "Hanyy_1022");//localhost是本机地址，3306是端口号，最后是用户名和密码
